...
import static org.notabug.lifeuser.ArraysOfCinemas.activity.BaseActivity.getLanguageParameter;
...
public class ShowFragment extends BaseFragment {
     ...
     */
    protected void showShowList(final View fragmentView) {
    ...
    public void search(String query) {
        ...
        mSearchShowArrayList = new ArrayList<JSONObject>();
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if(missingOverview) {
                    ...
                    Log.i("api request", "https://api.themoviedb.org/3/discover/"
                            + listType + "?" + filterParameter + "&page="
                            + page + "&api_key=" + API_KEY);
                } else {
                    url = new URL("https://api.themoviedb.org/3/discover/"
                            + listType + "?" + filterParameter + "&page="
                            + page + "&api_key=" + API_KEY + BaseActivity.getLanguageParameter());
                    Log.i("api request", "https://api.themoviedb.org/3/discover/"
                            + listType + "?" + filterParameter + "&page="
                            + page + "&api_key=" + API_KEY + BaseActivity.getLanguageParameter());
                }
